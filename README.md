## 🇷🇺 Русская версия
<img width="1915" height="1077" alt="Windows_view" src="https://github.com/user-attachments/assets/1dde338d-4d47-473b-87ad-1ce95d5bf5e2" />
...
Отображение:
* Прозрачного оверлея поверх всех окон
* Общего баланса **USDT**
* Открытых позиций
* Размера позиции
...
* Transparent overlay on top of all windows
* Total **USDT** balance
* Open positions
* Position size
...
* F12 toggle
* Auto-start & tray mode
* Clicking a position in “Current Positions” opens its chart
